...
pub struct QueryArgs {
    ...
    /// DataSource IDs
    #[arg(short = 'i', long = "data_source-ids", required_unless_present = "raw", value_delimiter = ',', value_parser = |s: &str| DatasetParser::from_id(s).ok_or("DataSource not found"))]
    ...
    #[arg(long, required_unless_present = "datasets")]
    raw: Option<String>,
}
